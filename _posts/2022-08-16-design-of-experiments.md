...
<div class="gallery" data-columns="2">
	<img src="/images/posts/theory/fullfact.png">
    <img src="/images/posts/theory/fracfact.png">
</div>
...
* Any column $\mathbf{x}_1$, $...$, $\mathbf{x}_k$ multiplied by itself results in the identity column $\mathbb{I}$, for instance, $\mathbf{x}_1 \odot \mathbf{x}_1 = \mathbf{x}_1^2 = \mathbb{I}$, or $\mathbf{x}_2 \odot \mathbf{x}_2 = \mathbf{x}_2^2 = \mathbb{I}$, and so on.
